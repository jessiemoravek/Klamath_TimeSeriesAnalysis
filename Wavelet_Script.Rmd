...
#WAVELET FIGURE
```{r}
png("Fig_APH_Wavelet_Combo.png", width = 500, height = 300)
wt.image(APH.w, color.key = "quantile", n.levels = 100, main = "Alexander Pond Wavelet",  
         legend.params = list(lab = "wavelet power levels", mar = 6.5, lab.line=4, label.digits = 4), 
         label.time.axis=TRUE,
         show.date=TRUE,
...
png("Fig_SPH_Wavelet_Combo.png", width = 500, height = 300)
wt.image(SPH.w, color.key = "quantile", n.levels = 100, main = "Stender Pond Wavelet",  
         legend.params = list(lab = "wavelet power levels", mar = 6.5, lab.line=4, label.digits = 4), 
         label.time.axis=TRUE,
         timelab = "Year",
         show.date=TRUE,
...
png("Fig_APHts_Combo.png", width = 500, height = 200)
ggplot()+
  geom_line(data = y_inter3_df, aes(x = date, y = temp), color = "#7c4b73")+
  labs(x = "Year",
       y = "Hourly Temperature (C)",
...
png("Fig_SPHts_Combo.png", width = 500, height = 200)
ggplot()+
  geom_line(data = y_inter4_df, aes(x = date, y = temp), color = "#e78429")+
  labs(x = "Year",
       y = "Hourly Temperature (C)",
