...
saveRDS(data_summer_SC,"data_summer_SC.RDS")
...
report(anova_SC)
anova_SC_residuals <- residuals(object = anova_SC )
shapiro.test(x = anova_SC_residuals) #check for normality
...
report(anova_HC)
anova_HC_residuals <- residuals(object = anova_HC )
...
report(anova_SC2)
anova_SC2_residuals <- residuals(object = anova_SC2 )
shapiro.test(x = anova_SC2_residuals) #check for normality
...
report(anova_HC2)
anova_HC2_residuals <- residuals(object = anova_HC2 )
