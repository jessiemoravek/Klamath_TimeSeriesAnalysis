...
f3a <- ggplot()+
  geom_line(data = quarterHour_condensed, aes(x = quarterHour, y = SC), color ="#D3D3D3", size = 1) +
  geom_line(data = daily_means_condensed, aes(x = day, y = SC), color = "#ed968c", size = 1) +
  geom_line(data = quarterHour_condensed, aes(x = quarterHour, y = May), color ="#ababab", size = 1) +
  geom_line(data = daily_means_condensed, aes(x = day, y = May), color = "#88a0dc", size = 1) +
  labs(title = "(a) May Pond and Seaid Creek", x = "Date", y = "Temperature (C)")+
  theme_classic()+
  theme(text=element_text(size=16),legend.position = "none")
...
f3c <- ggplot()+
  ...
  labs(x = "Sites",
       y = "Air Temperature Effects") +
  ggtitle("(c) Sensitivity to Air Temperature") +
  theme_classic()+
  theme(text=element_text(size=16),axis.text.x=element_text(angle = 45, hjust = 1))
