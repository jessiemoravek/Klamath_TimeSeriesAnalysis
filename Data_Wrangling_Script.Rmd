...
AP <- daily_means %>% rowid_to_column(var = "day") %>% ggplot()+
  geom_line(aes(x = day, y = AP1, color = "AP1")) +
  labs(x = "Day", y = "Temperature (degrees C)", color = "Legend")+
...
#Durazo
colorD <- c("Durazo" = "blue")
D <- daily_means %>% rowid_to_column(var = "day") %>% ggplot()+
  geom_line(aes(x = day, y = Durazo, color = "Durazo")) +
  labs(x = "Day", y = "Temperature (degrees C)", color = "Legend")+
  scale_y_continuous(name="Daily Mean Temp (C)",limits=c(0, 25))+
  theme_classic()+
...
LS <- daily_means %>% rowid_to_column(var = "day") %>% ggplot()+
  geom_line(aes(x = day, y = LS, color = "LS")) +
  labs(x = "Day", y = "Temperature (degrees C)", color = "Legend")+
  scale_y_continuous(name="Daily Mean Temp (C)",limits=c(0, 25))+
  theme_classic()+
...
May <- daily_means %>% rowid_to_column(var = "day") %>% ggplot()+
  geom_line(aes(x = day, y = May, color = "May")) +
  labs(x = "Day", y = "Temperature (degrees C)", color = "Legend")+
  scale_y_continuous(name="Daily Mean Temp (C)",limits=c(0, 25))+
  theme_classic()+
...
FG <- daily_means %>% rowid_to_column(var = "day") %>% ggplot()+
  geom_line(aes(x = day, y = FG3, color = "FG")) +
  labs(x = "Day", y = "Temperature (degrees C)", color = "Legend")+
  scale_y_continuous(name="Daily Mean Temp (C)",limits=c(0, 25))+
  theme_classic()+
...
#LL
colorLL <- c("LL1" = "blue", "LL2" = "red", "LL3" = "green")
