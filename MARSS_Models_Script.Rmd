...
daily_temp_means <- readRDS('daily_means_long_klamath.rds')
transformed_daily_temp_means <- readRDS('transformed_dat_klamath.rds')
transformed_daily_temp_means <- as.data.frame(t(transformed_daily_temp_means))

# Air tempertaure = covariate data
# Matrix of air temperatures summarized as daily mean temperature
# Includes data from 1 July 2020 to 13 July 2021 
covariate <- readRDS('covariate.rds')
transformed_covariate <- zscore(covariate)
```
