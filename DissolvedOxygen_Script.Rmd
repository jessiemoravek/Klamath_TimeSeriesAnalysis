...
endSP <- which(SP_DO$date == "2020-07-16 14:35:00 UTC", arr.ind = TRUE)
...
endDurazo <- which(Durazo_DO$date == "2020-07-23 12:15:00 UTC", arr.ind = TRUE)
...
endGP <- which(GP_DO$date == "2020-07-16 12:40:00 UTC", arr.ind = TRUE)
...
#cut off an hour on the back end
endLL <- which(LL_DO$date == "2020-07-16 10:55:00 UTC", arr.ind = TRUE)
